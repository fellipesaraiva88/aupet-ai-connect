...
router.get('/instance/test', asyncHandler(async (req: Request, res: Response) => {
  // Usar ID mockado para teste
  const userId = '98b7b609-e3cd-4955-884a-426ed4af136d';
  const organizationId = '51cff6e5-0bd2-47bd-8840-ec65d5df265a';
  ...
  try {
    ...
    const response: ApiResponse<{
      ...
      message: 'Instância do usuário obtida com sucesso (TEST MODE)',
      timestamp: new Date().toISOString()
    };
