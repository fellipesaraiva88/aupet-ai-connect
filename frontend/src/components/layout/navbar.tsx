...
export function Navbar({
  ...
  const handleSignOut = async () => {
    ...
    if (error) {
      ...
      toast({
        title: "Até logo! 👋",
        description: "Obrigado por cuidar tão bem dos pets hoje. Estamos aqui sempre que precisar!",
      });
    }
  };
      ...
      <div className="flex h-16 items-center justify-between px-6">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 rounded-[12px] bg-primary/6 px-3 py-1.5 border border-primary/10">
            ...
            <span className="text-[12px] font-medium text-primary tracking-[-0.01em]">Sistema Pet Care Ativo ✨</span>
          </div>
        </div>
