...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-glass focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden group",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-white shadow-glass hover:shadow-glow hover:animate-glass-float backdrop-blur-sm border border-ocean-200/20",
        ...
        hero: "bg-gradient-hero text-white shadow-glow hover:shadow-pet-glow hover:scale-105 font-semibold animate-glass-float",
    ...
    return (
      <Comp
        className={cn(
          ...
          // Pet-themed hover effect with paw print
          "before:content-['🐾'] before:absolute before:top-1 before:right-1 before:text-xs before:opacity-0 before:transition-all before:duration-300 hover:before:opacity-30 hover:before:animate-paw-print-reveal"
        )}
        ref={ref}
        {...props}
      />
