...
const AIConfig = () => {
  const [activeMenuItem] = useState("ai-config");
                      ...
                      <CardContent className="space-y-6">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            defaultValue="Assistente Pet Care"
                          />
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <Textarea
                            ...
                            defaultValue="Você é uma assistente virtual especializada em pet shops e clínicas veterinárias. Seja sempre cordial, profissional e prestativa. Demonstre paixão genuína pelo bem-estar dos animais. Use linguagem acessível e empática ao falar com os tutores dos pets."
                          />
                        </div>
                  ...
                  <TabsContent value="automation" className="space-y-6">
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        {[
                          { name: "Agendar Serviços", description: "Permitir que a IA agende banhos, tosas e consultas", enabled: true },
                          { name: "Reagendar Compromissos", description: "IA pode remarcar agendamentos existentes", enabled: true },
                          { name: "Informações de Preços", description: "Fornecer preços de serviços e produtos", enabled: true },
                          { name: "Status de Agendamentos", description: "Consultar e informar status de agendamentos", enabled: true },
                          { name: "Processar Pagamentos", description: "Iniciar processo de cobrança e pagamento", enabled: false },
                          { name: "Cancelar Serviços", description: "Permitir cancelamento de agendamentos", enabled: false },
